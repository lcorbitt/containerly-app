...
import type { ShipmentMapPoint } from "@/lib/shipment-map-points";
import { shipmentMapPointsToLatLngs } from "@/lib/shipment-map-points";
import "leaflet/dist/leaflet.css";

const ORANGE = "#ea580c";
const ORANGE_FILL = "rgba(234, 88, 12, 0.35)";
...
function kindLabel(kind: ShipmentMapPoint["kind"]): string {
  switch (kind) {
    case "explicit":
