...
export function NewShipmentForm({
  ...
  const applyImport = useCallback((draft: ShipmentImportDraft) => {
          ...
          <div className="mb-1 flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                Enter details manually or import from CSV/JSON. Upload documents and invite customers from the workspace
                after creation.
              </p>
            </div>
            <button
