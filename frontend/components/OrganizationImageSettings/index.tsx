...
import type { OrganizationImageSettingsProps } from "./types";
import { useOrganizationImageSettings } from "./useOrganizationImageSettings";
...
export function OrganizationImageSettings({
  ...
  initialOrgImagePath,
  onPathUpdated,
}: OrganizationImageSettingsProps) {
  const {
    inputRef,
    path,
    busy,
