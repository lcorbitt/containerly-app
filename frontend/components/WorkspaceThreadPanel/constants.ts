...
export const THREAD_TEAM_COMPOSER_BG_CLASS =
  "rounded-2xl bg-emerald-100 px-4 py-3 shadow-[0_1px_2px_rgba(15,23,42,0.04)] focus-within:ring-2 focus-within:ring-emerald-400/35 dark:bg-emerald-950/55 dark:shadow-[0_1px_2px_rgba(0,0,0,0.2)] dark:focus-within:ring-emerald-500/30";
...
export const THREAD_MESSAGE_QUOTE_SHELL_OWN_CLASS =
  "mb-3 border-r-[3px] pr-3 pl-25 rounded-l-md";

export const THREAD_MESSAGE_CONTENT_PAD_OTHER_CLASS = "min-w-0 pr-25";

export const THREAD_MESSAGE_CONTENT_PAD_OWN_CLASS = "min-w-0 pl-25";
