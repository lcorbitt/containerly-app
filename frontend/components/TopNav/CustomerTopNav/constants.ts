export const CUSTOMER_TOP_NAV_LAYOUT_CLASS = "flex w-full items-center";

export const CUSTOMER_TOP_NAV_LEFT_CLASS = "flex min-w-0 flex-1 items-center justify-start";

export const CUSTOMER_TOP_NAV_RIGHT_CLUSTER_CLASS =
  "flex min-w-0 flex-1 items-center justify-end gap-2 md:gap-3";

export const CUSTOMER_TOP_NAV_LINK_CLASS =
  "text-sm font-medium text-zinc-600 transition-colors hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white";

export const CUSTOMER_TOP_NAV_SECONDARY_LINK_CLASS =
...
export const CUSTOMER_TOP_NAV_THEME_TOGGLE_CLASS =
