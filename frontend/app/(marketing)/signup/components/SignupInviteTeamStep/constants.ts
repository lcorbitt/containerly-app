...
export const SIGNUP_INVITE_SELECT_CLASS =
  "h-10 w-full rounded-lg border border-zinc-200 bg-white px-3 text-sm text-zinc-900 focus:border-primary-orange/45 focus:outline-none focus:ring-2 focus:ring-primary-orange/15 disabled:opacity-60 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-primary-orange/55 dark:focus:ring-primary-orange/20";
...
export const SIGNUP_INVITE_ROLE_OPTIONS = [
