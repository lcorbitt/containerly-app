...
import { uploadContainerWorkspaceDocumentsForUser } from "@/services/workspace-actions.server";
...
export async function POST(
  ...
  try {
    const result = await uploadContainerWorkspaceDocumentsForUser(supabase, user.id, {
