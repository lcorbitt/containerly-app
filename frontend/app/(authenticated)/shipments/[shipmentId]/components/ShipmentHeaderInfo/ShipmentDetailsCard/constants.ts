export const SHIPMENT_DETAILS_CARD_CLASS =
  "relative shrink-0 overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-950";
...
export const SHIPMENT_DETAILS_CARD_EDIT_INNER_CLASS = "pointer-events-auto";
