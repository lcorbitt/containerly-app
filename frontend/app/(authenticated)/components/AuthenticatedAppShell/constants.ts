export const AUTHENTICATED_APP_SHELL_ROOT_CLASS =
  "grid h-dvh min-h-0 w-full grid-rows-[auto_minmax(0,1fr)] overflow-hidden";

export const AUTHENTICATED_APP_SHELL_BODY_CLASS = "flex min-h-0 flex-1 overflow-hidden";
