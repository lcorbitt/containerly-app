...
export function workspaceTabButtonClass(active: boolean): string {
  return `flex min-w-0 flex-1 basis-0 items-center justify-center gap-1.5 whitespace-nowrap border-b-2 px-2 py-2.5 text-center text-sm font-medium transition-colors ${
    active
