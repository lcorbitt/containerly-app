...
import { listOrgShipmentMessageThreads } from "@services/workspace/workspace.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const result = await listOrgShipmentMessageThreads(userClient, auth.userId, organizationId);
