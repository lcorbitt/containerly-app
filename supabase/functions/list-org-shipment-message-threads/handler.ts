...
import { loadOrgShipmentMessageThreadsForUser } from "@supabase-shared/workspace-operations.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const result = await loadOrgShipmentMessageThreadsForUser(userClient, auth.userId, organizationId);
