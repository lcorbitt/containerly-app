...
import { createPortalShipmentMessage } from "@services/shipment/portal/messages.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const result = await createPortalShipmentMessage(userClient, admin, auth.userId, {
