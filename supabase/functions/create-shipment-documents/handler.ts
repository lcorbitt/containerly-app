...
import { createShipmentScopeStandaloneFilesForUser } from "@services/workspace/workspace.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const uploaded = await createShipmentScopeStandaloneFilesForUser(userClient, auth.userId, {
