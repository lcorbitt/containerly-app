...
import { buildTrackingDashboardSnapshot } from "@supabase-shared/tracking-dashboard-operations.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const snapshot = await buildTrackingDashboardSnapshot(userClient, organizationId, auth.userId);
