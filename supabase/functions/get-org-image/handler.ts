...
import { fetchOrganizationImagePathQuery } from "@services/organization/organization.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const path = await fetchOrganizationImagePathQuery(userClient, organizationId);
