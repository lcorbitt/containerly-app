...
import { fetchCustomerDirectoryForOrganization } from "@supabase-shared/organization-operations.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const rows = await fetchCustomerDirectoryForOrganization(userClient, organizationId);
