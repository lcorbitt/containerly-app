...
import { uploadOrganizationImageAndSetPath } from "@supabase-shared/organization-operations.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const path = await uploadOrganizationImageAndSetPath(userClient, {
      organizationId,
      file,
      previousPath,
    });
