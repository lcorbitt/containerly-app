...
import { buildWorkspaceSummary } from "@supabase-shared/tracking-dashboard-operations.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const summary = await buildWorkspaceSummary(userClient, organizationId, auth.userId);
