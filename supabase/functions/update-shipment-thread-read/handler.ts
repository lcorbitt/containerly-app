...
import { updateShipmentThreadRead } from "@services/workspace/workspace.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    await updateShipmentThreadRead(userClient, auth.userId, organizationId, shipmentId);
