...
import { updateImporterShipmentThreadRead } from "@services/workspace/workspace.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    await updateImporterShipmentThreadRead(userClient, auth.userId, shipmentId);
