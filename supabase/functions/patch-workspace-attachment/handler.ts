...
import { renameWorkspaceAttachmentFileNameForUser } from "@services/workspace/workspace.service";
import type { PatchWorkspaceAttachmentBody } from "@shared/dto/workspace.dto";
