...
import { createContainerMessage } from "@services/workspace/workspace.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    const result = await createContainerMessage(userClient, auth.userId, auth.emailLower || null, {
