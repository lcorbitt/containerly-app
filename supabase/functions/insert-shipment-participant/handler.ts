...
import {
  insertShipmentParticipantQuery,
  runParticipantAddedNotification,
} from "@supabase-shared/shipment-operations.service.ts";
...
export async function handle(req: Request): Promise<Response> {
  ...
  try {
    ...
    await insertShipmentParticipantQuery(userClient, { shipmentId, userId: targetUserId });
