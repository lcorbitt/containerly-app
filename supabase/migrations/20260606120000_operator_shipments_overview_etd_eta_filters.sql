-- Operator shipments overview: ETD column, ETA/ETD date-range filters, sort by ETD.
...
comment on function public.operator_shipments_overview_page is
  'Paged operator shipment overview with tracking rows; supports ETA/ETD date filters and ETD column.';
