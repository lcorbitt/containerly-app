-- Add port_of_loading / port_of_destination to operator shipments overview for table columns.
...
comment on function public.operator_shipments_overview_page is
  'Paged operator shipment overview with tracking rows; includes commercial POL/POD for list columns.';
